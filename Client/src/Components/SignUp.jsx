        ...
        <div>
          ...
          >
            <p class="text-2xl font-medium text-center">
              <span class="text-red-500">User</span> Sign Up
            </p>

            <div class="relative group mb-4 mt-3">
              <input
                onChange={(e) =>
                ...
                type="text"
                id="name"
                class="block w-full px-4 py-3 text-gray-900 bg-transparent border-2 border-gray-200 rounded-xl appearance-none focus:outline-none focus:ring-0 focus:border-red-600 peer transition-colors"
                placeholder=" "
              />
              <label
                for="reg-email"
                class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-red-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-3"
              >
                Name
              </label>
            </div>
